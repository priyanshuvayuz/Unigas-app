...
const ViewFeedback = ({navigation}) => {
    ...
    return (
        <View style={{flex:1,backgroundColor:'rgb(255,255,255)'}}>
           ...
           <TouchableOpacity style={{position:'absolute', top:10,right:5,height:50,width:50}}  onPress={()=> navigation.navigate('Editf',{item:item})}>
           <Icons name="edit-2" size={20} color="#2e3092" />
           </TouchableOpacity>
