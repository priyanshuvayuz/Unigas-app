...
const EditOrder = ({navigation}) => {
    ...
    const [select2,setSelected2] = useState([item.cylinder_name])
    ...
    return(
      <>
        ...
        <View style={{flex:1,backgroundColor:'white',paddingBottom:60}}>
          ...
          <View style={{paddingBottom:60}}>
            <ScrollView>
              ...
              mode='outlined'
                style={styles.input}
              />
               {o?<Text style={{color:'red'}}>Please provide OrderId</Text>: null}
              </View>
              ...
              />
              {l?<Text style={{color:'red'}}>Please provide Location</Text>: null}
              </View>
          ...
          selectText="Select customer company"
